...
time raiss --chrom chr1 --gwas UACR --ld-folder ./ld/EUR --ref-folder ref/EUR/ --zscore-folder ./ --output-folder out/ --eigen-threshold 0.1 --minimum-ld 0 --R2-threshold 0.0 --window-size 1000000 --buffer-size 250000 --ref-panel-suffix '.csv' 
...
time raiss --chrom chr1 --gwas CAD --ld-folder ./ld/EUR --ref-folder ref/EUR/ --zscore-folder ./ --output-folder out/ --eigen-threshold 0.1 --minimum-ld 4 --R2-threshold 0.0 --window-size 1000000 --buffer-size 250000 --ref-panel-suffix '.csv' 
...
time ssimp --gwas CCANCER.txt ~/reference_panels/1000genomes/ALL.chr1.phase3_shapeit2_mvncall_integrated_v5a.20130502.genotypes.vcf.gz --out  SSIMP_COL_CANCER_EAS_chr1.txt  --sample.names ~/reference_panels/1KG/integrated_call_samples_v3.20130502.ALL.panel/sample/super_pop=EAS
